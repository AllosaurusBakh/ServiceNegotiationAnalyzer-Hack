...
ВНИМАНИЕ! В этом репозитории находится, то что реализовал я, а полная версия имеется по <a href="https://github.com/eresque/-Service-Negotiation-Analyzer">ссылке</a>.
